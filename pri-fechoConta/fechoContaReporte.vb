...
Public Class fechoContaReporte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pri_fechoConta.fechoContaReporte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_diario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedfechoContaReporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As fechoContaReporte = New fechoContaReporte()
        rpt.Site = Me.Site
        Return rpt
    End Function
