...
Public Class crystalReporter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pri_fechoConta.crystalReporter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrystalReporter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crystalReporter = New crystalReporter()
        rpt.Site = Me.Site
        Return rpt
    End Function
